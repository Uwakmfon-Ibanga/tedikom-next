  ...
  return (
    <Disclosure as="nav" className="">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <img className='w-[30%] sm:w-[12%]' src="/image.svg" alt="" />
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-[#04369A] hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset">
              ...
              <LuX aria-hidden="true" className="hidden size-6 group-data-open:block" />
            </DisclosureButton>
          </div>
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-[#04369A] text-white' : ' hover:bg-gray-700 hover:text-white',
          ...
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <BorderBotton text="Say Hello" image={<img src="/hand.svg" alt="button icon" />} />
